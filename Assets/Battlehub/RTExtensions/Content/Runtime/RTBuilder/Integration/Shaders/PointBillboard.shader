Shader "Battlehub/RTBuilder/PointBillboard"
{
        ...
        Pass
        {
            ...
            CGPROGRAM
                ...
                void geo(point GS_INPUT p[1], inout TriangleStream<FS_INPUT> triStream)
                {
                    ...
                    float scale = _Scale * _PBScaleMultiplicator;

                    geo_out.pos = ScreenToClip( float4(p[0].pos.x + scale, p[0].pos.y - scale, p[0].pos.z, p[0].pos.w - ScreenDepthModifier) );
    ...
    Fallback "Hidden/RTCommon/Point"
}
