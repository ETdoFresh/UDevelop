...
namespace Battlehub.RTEditor
{
    ...
    public class EditorsMapWindow : EditorWindow
    {
        ...
        private void Init()
        {
            ...
            Type[] types;
            ReflectionUtils.GetUOAssembliesAndTypes(out allAssemblies, out types);
            ...
            m_scriptEditorDescriptors = otherAssemblies.SelectMany(a => a.GetTypes())
                .Where(t => (typeof(MonoBehaviour).IsAssignableFrom(t) || typeof(ScriptableObject).IsAssignableFrom(t)) && t.IsPublic && !t.IsGenericType)
