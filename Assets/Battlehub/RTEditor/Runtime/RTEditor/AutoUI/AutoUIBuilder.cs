...
namespace Battlehub.RTEditor.UI
{
    public partial class AutoUI 
    {
        ...
        private void BuildHorizontalOrVerticalLayout<T>(Func<bool, ValueTuple<T, LayoutElement>> beginLayout,  Action endLayout, Stack<int> controlPath,  Stack<MemberInfo> viewModelPropertyPath, MemberInfo memberInfo, LayoutGroupAttribute layoutGroupAttribute) where T : HorizontalOrVerticalLayoutGroup
        {
