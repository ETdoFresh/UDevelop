...
namespace Battlehub.RTEditor
{
    ...
    public class InspectorView : RuntimeWindow
    {
        ...
        protected bool HasStaticObjects(UnityObject[] objects)
        {
            ...
            if (project != null)
            {
                foreach (UnityObject obj in objects)
                {
                    ...
                    ProjectItem item = project.Utils.ToProjectItem(obj);
                    if (item == null)
                    {
                        continue;
                    }

                    if (project.Utils.IsStatic(item))
                    {
                        return true;
                    }
                }
        ...
        private void CreateEditor()
        {
            ...
            if (HasStaticObjects(selectedObjects))
            {
                return;
            }
