...
namespace Battlehub.RTCommon
{
    ...
    public interface IRuntimeUndo
    {
        ...
        void AddComponentWithRequirements(ExposeToEditor obj, Type type);
    ...
    public class RuntimeUndo : IRuntimeUndo
    {
        ...
        public void AddComponentWithRequirements(ExposeToEditor obj, Type type)
        {
