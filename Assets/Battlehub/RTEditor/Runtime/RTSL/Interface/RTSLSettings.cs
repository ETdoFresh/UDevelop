...
namespace Battlehub.RTSL
{
    public class RTSLSettings
    {
        ...
        /// <summary>
        /// If set to false, prefabs imported from the asset library are not serialized and editing should be forbidden.
        /// </summary>
        public static bool SerializeAssetLibraryPrefabs = false;
